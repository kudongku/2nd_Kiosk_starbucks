...
## 상속관게 정리
### menu, drink, cake
메뉴는 부모클래스, drink 와 cake 는 자식클래스로 상속을 받습니다.
### drink, drinkType
drink 는 drinkType 을 포함합니다.
### order, drink
오더는 drink 를 사용합니다.
## 구현 결과
...
- 필수 요구사항
  ...
  > - 주문 클래스도 만들어서 상품 객체를 담을 수 있도록 해주세요.
   1. 메인 메뉴판 화면
      ...
      - 상품 메뉴 아래에는 Data.Order(주문)와 Cancel(주문 취소) 옵션을 출력해줍니다.
   ...
   4. 주문 화면
      - `5.Data.Order` 입력 시 장바구니 목록을 출력해줍니다.
